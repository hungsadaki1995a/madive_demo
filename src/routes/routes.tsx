...
const devRoutes: RouteItem[] = [
  {
    ...
    child: [
      ...
      },
      {
        ...
        fullPath: '/development/overview/meta/management',
      },
      {
        id: 'metaHistory',
        path: 'meta/history',
    ...
    child: [
      {
        ...
        fullPath: '/development/node/management',
      },
    ],
  },
  {
    ...
    child: [
      {
        ...
        icon: <SubIcon />,
        menuName: 'Test/Test',
        fullPath: '/development/test/management',
      },
      {
...
const configRoutes: RouteItem[] = [
  {
    ...
    child: [
      ...
      },
      {
        ...
        element: <UserHistory />,
        icon: <SubIcon />,
        fullPath: '/configuration/user/history',
      },
      {
        id: 'groupList',
